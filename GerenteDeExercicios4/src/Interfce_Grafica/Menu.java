...
public class Menu extends JFrame {
	...
	private JButton listaExerCasda, sorteaExecicio, sair;
	...
	public Menu(){
		...
		this.telaExercicio = new TelaExercicio(this.gerente);
		...
		this.container.setLayout(new GridLayout(17,1,0,4));
	...
	public void setMenu(JFrame tela){
		...
		if(tela instanceof TelaCadastroQuestao){
			...
			this.c.add(BorderLayout.EAST, t.getTelaAlteraPergunta());
		}else if(tela instanceof TelaExercicio){
			TelaExercicio t = (TelaExercicio) tela;
			try {
				t.motandoExercicio(this.gerente.getSorteaExercicio());
				this.c.add(BorderLayout.EAST, t.getTelaExercicio());
			} catch (ListaVaziaExeception e) {
				this.c.add(BorderLayout.EAST, t.getTelaExercicio());
				JOptionPane.showMessageDialog(null, e.getMessage());
				this.setMenu(this.getTelaPesquisa());
			}
	...
	private void inicializandoButao(){
		this.cadastraExercicio = new JButton("Cadastrar Exercicio");
		this.cadastraQuestao = new JButton("Cadastrar Questão");
		this.cadastraAluno = new JButton("Cadastrar Aluno");
		this.alteraPergunta = new JButton("Alterar Pergunta");
		this.alteraResposta = new JButton("Alterar Resposta");
		this.listaExerCasda = new JButton("Todos Exercicios");
		this.sorteaExecicio = new JButton("Sortear Exercicio");
	...
	private void inicializaEvento(){
		...
		this.eventoSorteaExecicio = new EventoSorteaExercicio(this);
	...
	private void addAoAoContainer(){
		...
		nome.setToolTipText("Aluno POO");
		nome2.setToolTipText("Aluno POO");
